...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Generate specs/premath/contracts/DOCTRINE-SITE-INPUT.json, "
            "Generate specs/premath/contracts/DOCTRINE-SITE.json and "
            "specs/premath/contracts/DOCTRINE-OP-REGISTRY.json from "
    ...
    parser.add_argument(
        ...
        "--source-map",
        type=Path,
        default=repo_root / "specs" / "premath" / "contracts" / "DOCTRINE-SITE-INPUT.json",
        help="Canonical doctrine-site input JSON output path",
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=repo_root / "specs" / "premath" / "contracts" / "DOCTRINE-SITE.json",
        help="Output doctrine-site map JSON path",
    )
    parser.add_argument(
        "--operation-registry-output",
        type=Path,
        default=repo_root / "specs" / "premath" / "contracts" / "DOCTRINE-OP-REGISTRY.json",
    ...
    parser.add_argument(
        "--cutover-contract",
        type=Path,
        default=repo_root / "specs" / "premath" / "contracts" / "DOCTRINE-SITE-CUTOVER.json",
