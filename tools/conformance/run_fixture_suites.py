...
SUITES: Tuple[Suite, ...] = (
    ...
    Suite(
        ...
        input_paths=(
            ...
            ROOT / "tools" / "toy",
            ROOT / "crates" / "premath-kernel" / "src" / "gate.rs",
            ROOT / "crates" / "premath-kernel" / "src" / "toy.rs",
            ROOT / "crates" / "premath-kernel" / "src" / "witness.rs",
            ROOT / "crates" / "premath-cli" / "src" / "cli.rs",
            ROOT / "crates" / "premath-cli" / "src" / "main.rs",
    ...
    Suite(
        suite_id="work-tracker-checker",
        domain="conformance.work-tracker-checker",
        command=("python3", "tools/conformance/run_work_tracker_checker_vectors.py"),
        input_paths=(
            ROOT / "tools" / "conformance" / "run_fixture_suites.py",
            ROOT / "tools" / "conformance" / "run_work_tracker_checker_vectors.py",
            ROOT / "tests" / "conformance" / "fixtures" / "work-tracker-checker",
            ROOT / "specs" / "premath" / "raw" / "WORK-TRACKER-CHECKER-PROFILE.md",
            ROOT / "crates" / "premath-kernel" / "src" / "work_tracker_checker.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "work_tracker_check.rs",
        ),
    ),
    Suite(
