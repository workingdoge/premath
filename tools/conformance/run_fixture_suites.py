...
def load_coherence_contract_input_paths() -> Tuple[Path, ...]:
    contract_path = ROOT / "specs" / "premath" / "contracts" / "COHERENCE-CONTRACT.json"
    base_paths: List[Path] = [
        ...
        ROOT / "crates" / "premath-cli" / "src" / "commands" / "check" / "coherence_check.rs",
    ]
    try:
...
SUITES: Tuple[Suite, ...] = (
    ...
    Suite(
        suite_id="statement-index",
        domain="conformance.statement-index",
        command=("python3", "tools/conformance/check_statement_index.py"),
        input_paths=(
            ROOT / "tools" / "conformance" / "run_fixture_suites.py",
            ROOT / "tools" / "conformance" / "check_statement_index.py",
            ROOT / "tools" / "conformance" / "run_statement_index_vectors.py",
            ROOT / "tests" / "conformance" / "fixtures" / "statement-index",
            ROOT / "specs" / "premath" / "draft" / "PREMATH-KERNEL.md",
        ),
    ),
    Suite(
        suite_id="statement-bindings",
        domain="conformance.statement-bindings",
        command=("python3", "tools/conformance/check_statement_bindings.py"),
        input_paths=(
            ROOT / "tools" / "conformance" / "run_fixture_suites.py",
            ROOT / "tools" / "conformance" / "check_statement_bindings.py",
            ROOT / "tools" / "conformance" / "run_statement_binding_vectors.py",
            ROOT / "tests" / "conformance" / "fixtures" / "statement-bindings",
            ROOT / "specs" / "premath" / "contracts" / "KERNEL-STATEMENT-BINDINGS.json",
            ROOT / "specs" / "premath" / "contracts" / "COHERENCE-CONTRACT.json",
            ROOT / "specs" / "premath" / "contracts" / "CONTROL-PLANE-CONTRACT.json",
        ),
    ),
    Suite(
        suite_id="statement-kcir",
        domain="conformance.statement-kcir",
        command=("python3", "tools/conformance/run_statement_kcir_vectors.py"),
        input_paths=(
            ROOT / "tools" / "conformance" / "run_fixture_suites.py",
            ROOT / "tools" / "conformance" / "run_statement_kcir_vectors.py",
            ROOT / "tools" / "conformance" / "check_statement_index.py",
            ROOT / "tests" / "conformance" / "fixtures" / "statement-kcir",
        ),
    ),
    Suite(
        suite_id="statement-projection-lane",
        domain="conformance.statement-projection-lane",
        command=("python3", "tools/conformance/check_statement_projection_lane.py"),
        input_paths=(
            ROOT / "tools" / "conformance" / "run_fixture_suites.py",
            ROOT / "tools" / "conformance" / "check_statement_projection_lane.py",
            ROOT / "tools" / "conformance" / "check_statement_index.py",
            ROOT / "artifacts" / "conformance" / "statement-index" / "latest.json",
            ROOT / "specs" / "premath" / "draft" / "PREMATH-KERNEL.md",
            ROOT / "specs" / "premath" / "contracts" / "KERNEL-STATEMENT-BINDINGS.json",
            ROOT / "crates" / "premath-bd" / "src" / "spec_ir.rs",
            ROOT / "crates" / "premath-bd" / "src" / "lib.rs",
        ),
    ),
    Suite(
        ...
        input_paths=(
            ...
            ROOT / "specs" / "premath" / "contracts" / "CAPABILITY-REGISTRY.json",
        ),
    ),
    Suite(
    ...
    Suite(
        ...
        command=(
            ...
            "rhai-eval",
            "--script",
            "tools/conformance/rhai/runtime_orchestration_vectors.rhai",
            "--trajectory-path",
            ".premath/cache/conformance/rhai-runtime-orchestration-trajectory.jsonl",
            "--json",
        ),
        input_paths=(
            ROOT / "tools" / "conformance" / "run_fixture_suites.py",
            ROOT / "tools" / "conformance" / "rhai" / "runtime_orchestration_vectors.rhai",
            ROOT / "tools" / "conformance" / "run_runtime_orchestration_vectors.py",
            ROOT / "tests" / "conformance" / "fixtures" / "runtime-orchestration",
            ROOT / "specs" / "premath" / "contracts" / "CONTROL-PLANE-CONTRACT.json",
            ROOT / "specs" / "premath" / "contracts" / "DOCTRINE-OP-REGISTRY.json",
            ROOT / "specs" / "premath" / "raw" / "HARNESS-RUNTIME.md",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "control_plane_gate.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "scheme_eval.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "rhai_eval.rs",
            ROOT / "tools" / "ci" / "governance_gate.py",
            ROOT / "tools" / "ci" / "kcir_mapping_gate.py",
        ),
    ),
    Suite(
        suite_id="frontend-parity",
        domain="conformance.frontend-parity",
        command=(
            "cargo",
            "run",
            "--package",
            ...
            "rhai-eval",
            "--script",
            "tools/conformance/rhai/frontend_parity_vectors.rhai",
            "--trajectory-path",
            ".premath/cache/conformance/rhai-frontend-parity-trajectory.jsonl",
            "--json",
        ),
        input_paths=(
            ROOT / "tools" / "conformance" / "run_fixture_suites.py",
            ROOT / "tools" / "conformance" / "rhai" / "frontend_parity_vectors.rhai",
            ROOT / "tools" / "conformance" / "run_frontend_parity_vectors.py",
            ROOT / "tests" / "conformance" / "fixtures" / "frontend-parity",
            ROOT / "specs" / "premath" / "contracts" / "CONTROL-PLANE-CONTRACT.json",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "scheme_eval.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "rhai_eval.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "transport_dispatch.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "mcp_serve.rs",
        ),
    ),
    Suite(
        suite_id="world-core",
        domain="conformance.world-core",
        command=(
            "cargo",
            "run",
            "--package",
            ...
            "rhai-eval",
            "--script",
            "tools/conformance/rhai/world_core_vectors.rhai",
            "--trajectory-path",
            ".premath/cache/conformance/rhai-world-core-trajectory.jsonl",
            "--json",
        ),
        input_paths=(
            ROOT / "tools" / "conformance" / "run_fixture_suites.py",
            ROOT / "tools" / "conformance" / "rhai" / "world_core_vectors.rhai",
            ROOT / "tools" / "conformance" / "run_world_core_vectors.py",
            ROOT / "tests" / "conformance" / "fixtures" / "world-core",
            ROOT / "specs" / "premath" / "contracts" / "CONTROL-PLANE-CONTRACT.json",
            ROOT / "specs" / "premath" / "contracts" / "DOCTRINE-OP-REGISTRY.json",
            ROOT / "specs" / "premath" / "contracts" / "DOCTRINE-SITE-INPUT.json",
            ROOT / "crates" / "premath-kernel" / "src" / "world_registry.rs",
            ROOT / "crates" / "premath-kernel" / "src" / "site_resolve.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "scheme_eval.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "rhai_eval.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "world" / "registry_check.rs",
            ROOT / "crates" / "premath-cli" / "src" / "commands" / "site_resolve.rs",
        ),
    ),
    Suite(
