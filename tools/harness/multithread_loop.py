...
CONTROL_PLANE_CONTRACT_PATH = REPO_ROOT / "specs/premath/contracts/CONTROL-PLANE-CONTRACT.json"
...
def load_worker_policy(repo_root: Path) -> WorkerPolicy:
    contract_path = repo_root / "specs" / "premath" / "contracts" / "CONTROL-PLANE-CONTRACT.json"
