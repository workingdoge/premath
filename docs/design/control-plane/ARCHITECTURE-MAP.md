...
- harness overlay (design): `docs/design/runtime/TUSK-HARNESS-CONTRACT.md`
...
- `docs/design/control-plane/STEEL-REPL-DESCENT-CONTROL.md`
...
- operator runbook for lifecycle/coherence flow:
  `docs/design/control-plane/LIFECYCLE-COHERENCE-FLOWS.md`.
...
- `docs/design/control-plane/MULTITHREAD-LANE-SITE-ADJOINTS.md`
- `docs/design/control-plane/DEVELOPMENT-META-LOOP.md`
- `docs/design/control-plane/TOOL-CALLING-HARNESS-TYPESTATE.md`
...
- for a compact status snapshot of `Ev`/coherence/issue posture, see
  `docs/design/control-plane/EV-COHERENCE-OVERVIEW.md`.
...
- context management operations (restore/edit/handoff) map to
  ...
  policies in `docs/design/control-plane/TOOL-CALLING-HARNESS-TYPESTATE.md`.
...
- Ralph-style one-task/fresh-context/backpressure loops map to
  ...
  update`) in `docs/design/control-plane/DEVELOPMENT-META-LOOP.md`, with detailed adaptation
  notes in `docs/design/operations/RALPH-PLAYBOOK-PREMATH.md`.
...
- design/operations lane: `docs/design/{runtime,transport,control-plane,operations}/*`,
  root operational docs, `.premath/*`, and issue-graph updates.
