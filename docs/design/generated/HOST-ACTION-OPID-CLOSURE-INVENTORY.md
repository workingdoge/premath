...
Source: `specs/premath/contracts/CONTROL-PLANE-CONTRACT.json`
...
- KR1/KR2 closure status: canonical operation IDs/classes/routes live in
  `specs/premath/contracts/DOCTRINE-OP-REGISTRY.json` and
...
- Add these operation IDs to:
  - `specs/premath/contracts/CONTROL-PLANE-CONTRACT.json` (`hostActionSurface.requiredActions.*.operationId`)
  - `specs/premath/contracts/DOCTRINE-OP-REGISTRY.json` (`operations[]`)
