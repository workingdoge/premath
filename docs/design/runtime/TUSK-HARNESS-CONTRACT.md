...
- Runtime shape: `docs/design/runtime/TUSK-ARCHITECTURE.md`
- Harness handoff artifact: this doc §11
- Harness feature ledger: `docs/design/runtime/TUSK-HARNESS-FEATURE-LEDGER.md`
- Harness trajectory rows: this doc §12
- Multithread runbook: `docs/design/runtime/TUSK-HARNESS-MULTITHREAD-RUNBOOK.md`
- KPI benchmark: this doc §13
- Harness retry policy table: `docs/design/runtime/TUSK-HARNESS-RETRY-POLICY.md`
- Identity/refinement/witness details:
  - `docs/design/runtime/TUSK-IDENTITY.md`
  - `docs/design/runtime/TUSK-REFINEMENT.md`
  - `docs/design/runtime/TUSK-WITNESSING.md`
...
Operation-routed host action bindings are contract-bound in
`specs/premath/draft/CONTROL-PLANE-CONTRACT.json` under
`replHostActionBindings`; unchecked local evaluator actions are outside this
transition surface.
