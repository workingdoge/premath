...
| adapter/runtime route parity lane | `tools/conformance/check_runtime_orchestration.py`, `tests/conformance/fixtures/runtime-orchestration/` | wrapper transport/format checks only; no duplicate world semantic vectors |
