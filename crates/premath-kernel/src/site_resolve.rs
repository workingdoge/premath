...
pub const DEFAULT_DOCTRINE_SITE_INPUT_REF: &str =
    "specs/premath/contracts/DOCTRINE-SITE-INPUT.json";
pub const DEFAULT_DOCTRINE_SITE_REF: &str = "specs/premath/contracts/DOCTRINE-SITE.json";
pub const DEFAULT_DOCTRINE_OP_REGISTRY_REF: &str =
