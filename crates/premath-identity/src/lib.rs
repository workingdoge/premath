//! Stable Premath identity contracts.
//!
//! This crate owns generic Premath identity semantics that downstream runtimes
//! such as Tusk may depend on without importing Tusk-specific operational
//! behavior.
