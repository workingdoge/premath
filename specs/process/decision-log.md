...
- observe read models: `crates/premath-surreal/src/observation.rs`,
  ...
  `crates/premath-cli/src/commands/observe/observe.rs`
...
- canonical contract artifact: `specs/premath/contracts/COHERENCE-CONTRACT.json`
- normative draft doc: `specs/premath/raw/PREMATH-COHERENCE.md`
...
- `premath coherence-check --contract specs/premath/contracts/COHERENCE-CONTRACT.json --repo-root . --json`
...
- `specs/premath/contracts/DOCTRINE-SITE-GENERATION-DIGEST.json`
...
`specs/premath/raw/SPEC-TRACEABILITY.md` as informational control documents
...
1. Add `premath spec-traceability-check` as the canonical validator for
   `specs/premath/raw/SPEC-TRACEABILITY.md` parity against promoted draft set.
