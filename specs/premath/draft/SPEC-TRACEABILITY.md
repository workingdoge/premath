...
| `SPAN-SQUARE-CHECKING.md` | `mise run coherence-check` (`span_square_commutation` via site vectors); `python3 tools/conformance/run_fixture_suites.py --suite coherence-contract` | covered | - |
