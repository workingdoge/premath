...
| `WORKFLOW-FIBRE-PROFILE.md` | `python3 tools/conformance/check_spec_traceability.py`; `mise run docs-coherence-check`; downstream consumer projection tests such as Tusk `project-workflow-fibre-profile --plan` | instrumented | - |
